...
describe ('Wallet', () => {
  let wallet, tp, bc;
   ...
   if('double the `sendAmount` substracted from the wallet balance', ()=>{
  ...
  describe('calculating a balance', ()=>{
    ...
    beforeEach(()=>{
     ...
     for (let i=0; i<repeatAdd; i++){
      ...
      it('calculates the balance for blockchain transcations matching the recipient', ()=>{
   ...
   describe ('and the recicipient conducts a transaction', ()=>{
   let subtractBalance, recipientBalance;
     ...
     beforeEach(()=>{
      ...
      wallet.createTransaction(senderWallet.publicKey, subtractBalance, bc, tp);     bc.addBlock(tp.transactions);
